...
module.exports = [
  ...
  {
    id: "get-user-1", // route id
    url: `/api/users/${USERS[0].id}`, // url in express format
    method: "GET", // HTTP method
    variants: [
      {
        id: "success", // variant id
  ...
  {
    id: "get-user-2", // route id
    url: `/api/users/${USERS[1].id}`, // url in express format
    method: "GET", // HTTP method
    variants: [
      {
        id: "success", // variant id
  ...
  {
    id: "get-user-3", // route id
    url: `/api/users/${ALL_USERS[2].id}`, // url in express format
    method: "GET", // HTTP method
    variants: [
      {
        id: "success", // variant id
